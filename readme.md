...
Simply re-run the script after waiting a short time. By the second run, the PCG user deletion will have completed, and the script will successfully delete the remaining PPSK user(s) without error.
